export default defineAppConfig({
  pages: [
    ...
    'pages/math/index',
    'pages/mathPractice/index',
    'pages/mentalMath/index',
    'pages/english/index',
    'pages/englishStudy/index',
    'pages/parent/index',
  ],
  window: {
  ...
  tabBar: {
    ...
    list: [
      ...
      },
      {
        ...
        text: '成就馆',
        iconPath: 'assets/tabbar/achievements.png',
        selectedIconPath: 'assets/tabbar/achievements-selected.png',
      },
      {
